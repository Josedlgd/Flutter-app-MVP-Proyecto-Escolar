...
class ProductService {
  static List<ProductDB> productData =
      productRawData.map((data) => ProductDB.fromJson(data)).toList();
  // static List<ProductDB> searchedProductData = searchedProductRawData.map((data) => ProductDB.fromJson(data)).toList();
}
